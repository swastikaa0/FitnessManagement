      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="w-12 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-black-500 rounded-full peer peer-checked:bg-black-600"></div>
